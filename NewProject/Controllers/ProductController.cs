...
namespace StockMANAGEMENT.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            ViewBag.Subcategories = new SelectList(_subcategoryManager.ListAllSubcategory, "Subcategory_id", "Subcategory_name");
            return View();
        }
        ...
        public IActionResult Add(Product product)
        {
            ...
            ViewBag.Subcategories = new SelectList(_subcategoryManager.ListAllSubcategory, "Subcategory_id", "Subcategory_name", product.Subcategory_id);
            return View(product);
        }
